  ...
  return (
    <footer className="mt-20 border-t border-slate-800 bg-slate-950/90 text-slate-400 text-xs py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          <h4 className="font-semibold text-slate-200 mb-3 text-xs uppercase tracking-wider">System Policy & Branding</h4>
          ...
          <div className="mt-4 pt-3 border-t border-slate-800 flex items-center gap-1.5 text-xs text-amber-400 font-bold">
            <span>Built with</span>
            <Heart className="w-4 h-4 fill-current text-rose-500 animate-pulse" />
            <span>by Venky with Bujji 💖</span>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 mt-8 pt-6 border-t border-slate-900 flex flex-col sm:flex-row items-center justify-between text-[11px] text-slate-400 gap-2">
        <p className="font-semibold text-amber-400/90">© 2026 AI Government Scheme Finder • Built by Venky with Bujji 💖</p>
